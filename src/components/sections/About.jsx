...
const cards = [
  ...
  [FaBrain, "Machine Learning", "PyTorch · Computer Vision · Uncertainty Quantification"],
];
    ...
    <section id="about" className="border-b border-white/10 bg-[#070a0f]">
      <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:py-32">
        <div className="grid gap-16 lg:grid-cols-[.8fr_1.2fr]">
          ...
          <div>
            <p className="text-xl leading-9 text-slate-300 sm:text-2xl">I’m a Computer Science graduate building dependable full-stack products — from database models and authentication to API design, responsive UI, deployment and production debugging — alongside applied ML research in computer vision.</p>
            <p className="mt-7 max-w-3xl leading-8 text-slate-500">My work spans recruitment, travel, healthcare, education and geospatial/ML systems, plus published research on uncertainty-aware satellite image segmentation presented at ICIET-2026. I care about the details recruiters eventually experience as users: clear interfaces, predictable APIs, sensible data models, and software that behaves well outside a demo environment.</p>
          </div>
        </div>
