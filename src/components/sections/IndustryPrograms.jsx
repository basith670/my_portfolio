  ...
  return (
    <section id="programs" className="border-b border-white/10 bg-[#0b0f16]">
      <div className="mx-auto max-w-7xl px-5 py-24 sm:px-8 lg:py-28">
        <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between"><div><p className="font-mono text-xs font-bold uppercase tracking-[.25em] text-blue-400">09 / Industry exposure</p><h2 className="mt-4 text-4xl font-black tracking-tight text-white">Beyond the codebase.</h2></div><p className="max-w-md text-sm leading-6 text-slate-500">Selected simulations and structured programs that broadened my engineering and cloud perspective.</p></div>
