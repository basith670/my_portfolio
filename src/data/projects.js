const projects = [
...

  {
    ...
    tech: ["React", "Django", "DRF", "OpenAI", "PostgreSQL", "Tailwind"],
...

  {
    ...
    status: "Live",
    description:
      "A complete Hospital Management System with doctor and patient authentication, appointment booking, medical report management, role-based dashboards, secure authentication, and responsive UI.",
    tech: ["React", "Django", "DRF", "PostgreSQL", "JWT", "Bootstrap"],
...

  {
    ...
    description:
      "Evidential Deep Learning framework integrated with a SegFormer (MiT-b3) backbone for high-resolution satellite image segmentation and single-pass epistemic uncertainty quantification.",
    tech: [
      "PyTorch",
      "SegFormer",
    ...
    github:
      "https://github.com/hrishidev1/Transformer-based-satellite-segformer",
    live: "",
  },
];
